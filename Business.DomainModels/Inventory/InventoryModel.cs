...
namespace Business.DomainModels.Inventory
{
    ...
    {
        public static Type[] Types = new Type[] { typeof(Category), typeof(Item) };
    }
    ...
    public partial class Category : EntityBase
    {
        ...
        protected override void Initialize()
        {
            ...
            this.Items = new RelatedList<Item>(this, ItemsPropertyMetadata);
        }
        static Category()
        {
            _Initialize();
    ...
    public partial class Item : EntityBase
    {
        ...
        [ForeignKey(typeof(Category), "CategoryID", "Category", Name = "FK_InventoryToCategory")]
        public int CategoryID
        {
            get { return (int)this.GetValue(CategoryIDPropertyMetadata); }
            set { this.SetValue(CategoryIDPropertyMetadata, value); }
    ...
    public partial class EntityRelations
    {
        ...
        public static EntityRelation FK_InventoryToCategory = EntityRelation.Register(new EntityRelation("FK_InventoryToCategory",
            typeof(Category), new EntityProperty[] { Category.CategoryIDPropertyMetadata }, Multiplicity.One, Category.ItemsPropertyMetadata,
            typeof(Item), new EntityProperty[] { Item.CategoryIDPropertyMetadata }, Multiplicity.Many, Item.CategoryPropertyMetadata));
